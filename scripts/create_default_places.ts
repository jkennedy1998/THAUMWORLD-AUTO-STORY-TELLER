...
import type { Place, PlaceConnection, PlaceFeature } from "../src/types/place.js";
...
function create_eden_crossroads_places() {
  // Main Town Square
  const square_result = create_basic_place(
    DATA_SLOT,
    "eden_crossroads",
    "eden_crossroads_square",
    "Town Square",
    { is_default: true, width: 40, height: 40 }
  );
  ...
  // Tavern - Common Room
  const tavern_common_result = create_basic_place(
    DATA_SLOT,
    "eden_crossroads",
    "eden_crossroads_tavern_common",
    "The Singing Sword - Common Room",
    { width: 30, height: 25 }
  );
...
function create_eden_whispering_woods_places() {
  const clearing_result = create_basic_place(
    DATA_SLOT,
    "eden_whispering_woods",
    "eden_whispering_woods_clearing",
    "Forest Clearing",
    { is_default: true, width: 35, height: 35 }
  );
...
function create_eden_stone_circle_places() {
  const circle_result = create_basic_place(
    DATA_SLOT,
    "eden_stone_circle",
    "eden_stone_circle_center",
    "The Stone Circle",
    { is_default: true, width: 30, height: 30 }
  );
...
function create_eden_commons_places() {
  const green_result = create_basic_place(
    DATA_SLOT,
    "eden_commons",
    "eden_commons_green",
    "The Village Green",
...
function create_grendas_shop() {
  const shop_result = create_basic_place(
    DATA_SLOT,
    "eden_crossroads",
    "eden_crossroads_grendas_shop",
    "Grenda's General Goods",
    { width: 20, height: 20 }
  );
