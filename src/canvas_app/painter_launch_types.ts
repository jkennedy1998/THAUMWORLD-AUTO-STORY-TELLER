export type PainterLaunchIntent =
  ...
  | { kind: 'join_authoritative'; slot: number; document_id: string; display_name: string; join_target_id: string; api_base_url?: string | null; bridge_ws_base_url?: string | null; host_boot_id?: string | null; persist_recent?: boolean };
